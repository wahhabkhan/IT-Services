 ...
 */
class Engitech_Pricing_Table_Horizontal extends Widget_Base{
	...
	public function get_title() {
		return __( 'Engitech Pricing Table Horizontal', 'engitech' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ot-pricing-table.--horizontal' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				'name' => 'box_border',
				'selector' => '{{WRAPPER}} .ot-pricing-table.--horizontal',
			]
		);
		$this->add_responsive_control(
			'box_radius',
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .ot-pricing-table.--horizontal' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		<div class="ot-pricing-table --horizontal s4">
...
// After the Engitech_Pricing_Table_Horizontal class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Engitech_Pricing_Table_Horizontal() );