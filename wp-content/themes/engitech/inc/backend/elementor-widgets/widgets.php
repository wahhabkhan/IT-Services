...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/pricing-table-4.php' );
...
require_once( get_template_directory() . '/inc/backend/elementor-widgets/testimonial-carousel-6.php' );
